...
plt.tight_layout()
plt.savefig('nashik_demographics.png')
plt.show()
...
# Update layout
fig.update_layout(
    title_text="Demographic Analysis - Nashik",
    showlegend=True,
    height=800
)
...
# Show the figure
fig.write_html('nashik_dashboard.html')
print(f"✅ Saved interactive dashboard to nashik_dashboard.html")
...
plt.title('Heat Vulnerability Index - Nashik', fontsize=16)
...
plt.tight_layout()
plt.savefig('nashik_hvi.png')
plt.show()

# Save HVI results
hvi_df.to_csv('nashik_hvi.csv', index=False)
print(f"✅ Saved HVI results to nashik_hvi.csv")
...
print(f"Top Mitigation Recommendations for Nashik:")
print(rec_df)
...
plt.title('Mitigation Action Priority Scores - Nashik', fontsize=16)
plt.ylabel('Priority Score', fontsize=12)
plt.xticks(x + width*2, top_neighborhoods)
plt.legend()
plt.tight_layout()
plt.savefig('nashik_recommendations.png')
plt.show()

# Save recommendations
rec_df.to_csv('nashik_recommendations.csv', index=False)
print(f"✅ Saved recommendations to nashik_recommendations.csv")